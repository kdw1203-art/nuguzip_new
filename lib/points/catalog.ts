...
export const POINTS_GRATUITOUS_NOTICE =
  "내집나우 포인트는 출석·기록 공개·친구 초대 같은 활동으로만 적립되는 무상 리워드입니다. 현금으로 구매(충전)할 수 없고, 현금으로 환불·전환되지 않으며, 회원 간 양도가 불가합니다. 적립일로부터 6개월이 지나면 소멸됩니다. 내집나우에는 포인트 충전(유상 판매) 기능이 없으며, 앞으로도 도입할 계획이 없습니다.";
