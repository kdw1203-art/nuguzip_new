 ...
 * 3) 내집나우 고유 지표(시장 온도)는 방법론 페이지의 정의를 원문으로 링크한다.
 */
...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  /* ── 거래·시세 ─────────────────────────────────────────── */
  {
    ...
    def: "실거래가는 실제로 체결돼 국토교통부에 신고된 계약의 거래 금액입니다. 부동산 포털에 올라오는 매물 호가(부르는 값)와 달리, 신고 기한(계약 후 30일) 안에 신고된 실제 계약만 집계됩니다. 내집나우의 모든 시세는 실거래가 기준입니다.",
    extra: "신고 기한이 30일이므로 최근 1~2개월 수치는 아직 신고가 다 들어오지 않은 잠정치입니다. 내집나우는 해당 기간의 리포트에 잠정 표시를 붙입니다.",
    category: "거래·시세",
  ...
  },
  {
    ...
    def: "해제거래는 체결 신고 후 취소된 계약입니다. 해제거래를 시세 평균에 포함하면 단지 평균가가 크게 왜곡될 수 있어, 내집나우는 해제 신고분을 시세 집계에서 제외합니다.",
    category: "거래·시세",
    related: ["silgeoraega"],
    href: "/methodology",
    hrefLabel: "내집나우의 해제거래 처리 방식",
  },
  {
    slug: "pyeongdanga",
    term: "평당가",
  ...
  },
  {
    ...
    def: "실거래가 공개시스템은 국토교통부가 신고된 부동산 거래 내역을 일반에 공개하는 시스템입니다. 아파트·연립다세대·단독다가구의 매매와 전월세 자료가 공개되며, 내집나우는 이 자료를 공공데이터포털(data.go.kr) API 로 받아 집계합니다.",
    category: "거래·시세",
    related: ["silgeoraega"],
    href: "/methodology",
    hrefLabel: "집계 방법론",
  ...
  },
  {
    ...
    def: "임장은 매수·임차를 검토하는 집과 동네를 직접 방문해 확인하는 일입니다. 시세표에 나오지 않는 소음·채광·경사·생활 동선을 확인하는 과정으로, 내집나우는 임장 기록(임장노트)을 판단 근거로 쌓는 것을 돕는 서비스입니다.",
    category: "거래·시세",
    related: ["silgeoraega"],
    href: "/notes/new",
    hrefLabel: "임장노트 쓰기",
  ...
  /* ── 면적·구조 ─────────────────────────────────────────── */
  {
    ...
    def: "전용면적은 현관 안쪽에서 세대가 독점적으로 사용하는 면적입니다. 계단·복도 등을 포함한 공급면적과 다르며, 실거래 신고와 내집나우의 면적대 구분은 모두 전용면적 기준입니다. 흔히 말하는 '84㎡(국민평형)'가 전용면적 표기입니다.",
    category: "면적·구조",
    href: "/tx",
  ...
  },
  {
    ...
    def: "원리금균등상환은 대출 기간 내내 매달 같은 금액(원금+이자)을 갚는 방식입니다. 초기에는 상환액 중 이자 비중이 크고 갈수록 원금 비중이 커집니다. 내집나우 시나리오 계산기는 30년 원리금균등을 기본으로 계산합니다.",
    category: "대출·상환",
  ...
  /* ── 내집나우 고유 지표 ──────────────────────────────────── */
  {
    slug: "sijang-ondo",
    term: "시장 온도",
    short: "내집나우가 정의한 0~100 합성 지표(50 중립).",
    def: "시장 온도는 내집나우가 지역 시장의 가격·거래 활동을 0~100으로 요약한 합성 지표입니다. 50이 중립이며, 매매가격지수 모멘텀과 실거래 거래량 추이라는 두 실측치에서만 계산합니다. 매수·매도 추천이 아니라 시장 상태의 서술이며, 공식 통계가 아닌 내집나우 고유 지표이므로 인용 시 출처를 함께 밝혀 주세요.",
    category: "내집나우 지표",
