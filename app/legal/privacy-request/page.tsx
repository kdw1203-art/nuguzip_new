    ...
    <main className="mx-auto w-full max-w-3xl">
      <article className="card rise-in p-6">
        ...
        <section className="mt-6">
          <h2 className="text-[15px] font-semibold text-ink">요청 가능한 항목</h2>
          <ul className="ml-4 mt-2 list-disc space-y-1 text-[13px] text-text-1">
        ...
        <section className="mt-6 space-y-2 text-[13px] leading-7 text-text-1">
          <h2 className="text-[15px] font-semibold text-ink">요청 방법</h2>
        ...
        <section className="mt-6 space-y-2 text-[13px] leading-7 text-text-1">
          <h2 className="text-[15px] font-semibold text-ink">처리 기한</h2>
          <p>
