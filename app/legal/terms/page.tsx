    ...
    <main className="mx-auto w-full max-w-3xl">
      <article className="card rise-in p-6 md:p-8">
        ...
        <Section num="8" title="유료 서비스 및 결제" id="refund">
          ...
          <p>④ 현재 판매하는 모든 이용권(주간권·월간·연간)은 1회성 단건 결제로 자동 갱신되지 않으며, 이용 기간 중 중도 해지 시 잔여 기간을 일할 계산하여 환불합니다(고객센터 접수). 회사가 정기결제(자동 갱신형) 상품을 도입하는 경우에는 결제 전에 갱신 주기·금액·해지 방법을 고지하고 회원의 명시적 동의를 받으며, 회원은 언제든지 해지를 신청할 수 있습니다.</p>
          <p>⑤ 결제 대행 서비스는 토스페이먼츠(주) 등을 이용하며, 결제 관련 세부 사항은 각 결제 대행사의 이용약관을 따릅니다.</p>
        </Section>

        {/* 제8조의2 — 포인트(무상 리워드). 표준 조문 번호 표기(제N조의2)를 위해
        ...
        <section id="points" className="mt-8 scroll-mt-24">
          ...
          <div className="mt-2 space-y-2 text-sm leading-7 text-text-1">
            <p>① 회사가 제공하는 포인트는 출석, 기록 공개, 친구 초대 등 서비스 내 활동에 대한 보상으로만 적립되는 무상(無償) 리워드이며, 회사는 포인트를 유상으로 판매(충전)하지 않습니다.</p>
            <p>② 포인트는 현금으로 구매·환불·전환할 수 없으며, 회원 간 양도가 불가합니다.</p>
            <p>③ 포인트의 유효기간은 적립일로부터 6개월이며, 유효기간이 지난 포인트는 자동으로 소멸됩니다.</p>
            <p>④ 포인트는 회사가 정한 사용처(구독 이용권 교환, 매물 노출 등)에서만 사용할 수 있습니다. 회사의 귀책사유로 사용 처리가 잘못된 경우 회사는 해당 포인트를 복구합니다.</p>
            <p>⑤ 부정한 방법으로 적립된 포인트는 회사가 회수할 수 있습니다.</p>
            <p>⑥ 회사가 포인트 제도를 중대하게 변경하거나 종료하는 경우 30일 전에 서비스 내에 공지하며, 이미 적립된 포인트는 공지된 기간 동안 사용할 수 있도록 보장합니다.</p>
          </div>
        </section>
