...
export const metadata = buildPageMetadata({
  ...
  description:
    "누구집 단지 실거래 시세를 블로그·카페에 iframe 한 줄로 붙여넣는 방법. 국토교통부 실거래 신고 자료를 그대로 보여 주며, 시세가 갱신되면 붙여넣은 위젯도 함께 갱신됩니다.",
  path: "/widget",
});
...
const FAQ = [
  ...
  },
  {
    ...
    a: "네. 위젯은 이미지가 아니라 누구집 페이지를 불러오는 iframe 이라, 실거래가 새로 집계되면 이미 붙여넣은 글의 숫자도 함께 바뀝니다. 글을 다시 수정할 필요가 없습니다.",
  },
  {
    q: "데이터를 불러오지 못하면 어떻게 되나요?",
    a: "숫자를 지어내지 않고 '시세를 불러오지 못했어요' 카드가 대신 표시됩니다. 남의 글 안에서 확인되지 않은 가격이 누구집 이름을 달고 노출되는 일이 없도록 한 처리입니다.",
  },
  {
    q: "사용료가 있나요? 출처 표기를 지워도 되나요?",
    a: "무료이며 별도 신청 절차도 없습니다. 다만 위젯 안의 누구집 표기와 '국토교통부 실거래가 기준' 문구는 데이터 출처를 밝히는 부분이니 지우지 말고 그대로 두어 주세요.",
  },
];
