...
const SUBSCRIPTION_FAQ: FaqItem[] = [
  ...
  {
    q: "결제는 어떻게 하나요?",
    a: "월간 또는 연간 이용권 방식입니다. 결제가 아직 열려 있지 않은 기간에는 '오픈 알림 받기'로 등록해 두면 열리는 즉시 알림을 드립니다. 포인트 상점에서 포인트로 PRO 이용권을 교환할 수도 있습니다. 포인트는 현금으로 구매(충전)할 수 없는 활동 적립 무상 리워드입니다.",
  },
  {
    q: "이용권은 자동으로 갱신되나요?",
    a: "아니요. 카드·카카오페이·포인트 교환 등 현재 판매하는 모든 이용권은 기간제 단건 결제라 자동으로 갱신·재청구되지 않으며, 만료 7일 전과 1일 전에 알림을 드립니다. 정기결제(자동 갱신형)를 도입하는 경우에는 결제 전에 갱신 조건을 고지하고 동의를 받은 뒤 적용합니다.",
  },
  {
    q: "해지·환불은 어떻게 하나요?",
