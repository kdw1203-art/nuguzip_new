...
export const SUBSCRIPTION_SERVICE_PERIOD_TEXT =
  "서비스 제공기간: 결제(이용권 등록) 즉시 적용되며, 선택한 기간(주간권 7일 · 월간 1개월 ~ 최대 12개월) 동안 제공됩니다. 주간권은 1회성 단건 결제로 자동 반복청구가 없습니다. 결제 후 7일 이내 청약철회(전액 환불) 가능, 이후 중도 해지 시 잔여기간 일할 환불(고객센터 접수) — 상세 규정은 이용약관 제8조.";
