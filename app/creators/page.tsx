...
/* ============================================================
   ...
   - 정산은 포인트 적립이 사실이고 현금 출금 인프라는 준비 중 — 그대로 고지
...
export const metadata = buildPageMetadata({
  ...
  description:
    "임장·지역 분석 리포트를 누구집 자료실에서 판매하는 크리에이터 입점 안내. 노트 작성부터 리포트 판매까지의 절차와 정산 방식을 사실대로 안내합니다.",
  path: "/creators",
});
...
const WHY = [
  ...
  },
  {
    ...
    desc: "누구집 방문자는 실거래가를 확인하고 임장을 준비하러 온 사람들입니다. 그 지역 리포트가 필요한 순간의 독자에게 바로 닿습니다.",
  },
  {
...
const FAQ = [
  {
    q: "누가 입점할 수 있나요?",
    a: "누구집 계정이 있으면 누구나 리포트를 등록할 수 있습니다. 본인·자격 인증을 마친 판매자와 전문가 구독 회원은 우대 요율이 적용됩니다.",
  },
  {
    q: "무엇을 팔 수 있나요?",
  ...
  {
    q: "정산은 어떻게 되나요?",
    a: "판매 수익은 포인트(P)로 적립되며, 수수료율은 수수료 안내 페이지의 공표 요율을 따릅니다. 현금 출금 인프라는 준비 중이라 아직 출금은 열려 있지 않습니다 — 개시되면 크리에이터 센터에 먼저 공지합니다.",
  },
];
    ...
    <PageShell breadcrumb="홈 › 크리에이터 입점">
      ...
      <div className="mb-7 max-w-[720px]">
        ...
        <p className="mt-2 text-[14px] leading-[1.7] text-text-2">
          발로 뛰어 만든 지역 분석과 임장 기록을 누구집 자료실에서 리포트로
      ...
      <div className="mb-8 max-w-[720px] rounded-2xl border border-line bg-[#f7f9fc] px-4 py-3.5">
        ...
        <ul className="mt-1.5 flex flex-col gap-1 text-[12px] leading-[1.65] text-text-2">
          ...
          <li>
            · 정산은 포인트(P) 적립이며, 현금 출금 인프라는 준비 중입니다. 개시
            전에는 출금이 불가합니다.
          </li>
          <li>
            · 수수료는{" "}
