    ...
    return (
      <PageShell breadcrumb="마이 › 전문가 프로필">
        <div className="card mx-auto mt-8 max-w-[520px] rounded-2xl px-5 py-8 text-center">
          <p className="text-[14px] font-extrabold text-ink">로그인이 필요해요</p>
          <Link
    ...
    return (
      <PageShell breadcrumb="마이 › 전문가 프로필">
        <div className="card mx-auto mt-8 max-w-[560px] rounded-2xl px-5 py-8 text-center">
          ...
          <p className="mx-auto mt-1.5 max-w-[420px] text-[12px] leading-[1.7] text-text-3">
  ...
  return (
    <PageShell breadcrumb="마이 › 전문가 프로필">
      <div className="mx-auto w-full max-w-[640px]">
        <div className="mb-4">
          <h1 className="text-[20px] font-extrabold text-ink">전문가 프로필 관리</h1>
