  ...
  return (
    <div className="rise-in card mb-4 flex flex-wrap items-center gap-3 p-4">
      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
        <span className="flex items-center gap-1.5 t-sub font-extrabold text-primary">
      ...
      <Link
        ...
        className="btn-cta shrink-0 rounded-full px-4 py-2 t-body font-extrabold no-underline tap-ripple"
      >
        답변 쓰기 +50P
      </Link>
    </div>
