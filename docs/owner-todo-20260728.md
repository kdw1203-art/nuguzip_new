...
| 학교알리미 | `SCHOOLINFO_API_KEY` | https://www.schoolinfo.go.kr | 학군 정보(학생수·진학률) |
| 한국도로공사 혼잡빈도 | `EX_DATA_API_KEY` | https://www.data.go.kr/data/15045664/fileData.do | 출퇴근 동선·장거리 이동 분석 |
| 한국부동산원 주간동향 | `REB_SERVICE_KEY` | https://www.reb.or.kr | 주간 시세 변동률 위젯 |
| 금융상품 금리 | `FINLIFE_API_KEY` | https://finlife.fss.or.kr | 주담대 실제 공시금리 기반 자금계획 |

전부 무료 신청이고, 승인까지 보통 즉시~1영업일입니다(추정 — 기관별로 다릅니다).
